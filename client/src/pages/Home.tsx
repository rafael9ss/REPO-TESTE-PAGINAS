        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 md:mb-6 leading-tight px-4">
              VOCÊ TENTA VENDER NA SHOPEE MAS A CONTA NÃO FECHA E AS VENDAS NÃO VÊEM?
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#ff6b35] mb-6 md:mb-8 px-4">
              Eu passei por isso. Mas descobri 7 ajustes simples que mudaram tudo — e vou te mostrar cada um deles.
            </p>
            {/*
            ...
            */}
            <div
              dangerouslySetInnerHTML={{
                __html:
                  '<vturb-smartplayer id="vid-692dc6f83dbab420e98ff2ad" style="display: block; margin: 0 auto; width: 100%; max-width: 400px;"></vturb-smartplayer> <script type="text/javascript"> var s=document.createElement("script"); s.src="https://scripts.converteai.net/a930954b-410c-46a3-9750-318da063a52e/players/692dc6f83dbab420e98ff2ad/v4/player.js", s.async=!0,document.head.appendChild(s); </script>',
              }}
            />
            <div className="bg-gray-900 text-gray-100 p-6 sm:p-8 rounded-xl my-6 max-w-3xl mx-auto">
